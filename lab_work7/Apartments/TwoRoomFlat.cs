...
{
    /// <summary>
    /// The class representing a two-room flat 
    /// </summary>

    public class TwoRoomFlat : Flat
    {
        /// <summary>
        /// Creates an instance of the TwoRoomFlat class
        /// </summary>
        ...
        public TwoRoomFlat(int numberOfRooms, Room[] rooms, int floor, bool washerAvailability,
        ...
        public override string FlatType { get { return "Two-room flat"; } }
        ...
        public override string ToString()
        {
            ...
            if (WasherAvailability == true)
                ...
                washer = "No";
            return $"Two-room flat; Rent:{Math.Round(FlatRent, 1)}; Floor:{Floor}; Washer:{washer}; Stove type:{StoveType}";
        }
    }
}
